...
<?php include "include/header.php" ?>
  ...
  <section class="section_wrap_col">
    <section class="colonne" id="todo">
      ...
      <section class="tache">
      <div class="base" draggable="true">
      <?php $_SESSION["user"]->recup_tache_todo()
      
      ?>
      <div class="info_tache">
            <p><?php echo $_SESSION['user']->gettitre();?>e</p>
            <p class="etat"><img class="icone" src="img/non.png"></p>
          </div>
          <div class="descr_tache">
            <p class="date_creation">Créée le :<?php echo $_SESSION['user']->getdate();?></p>
            <p class="etat_txt">Etat : <?php echo $_SESSION['user']->getEtat();?></p>
            <p class="description">Description : <?php echo $_SESSION['user']->getdescription();?></p>
          </div>
          </div>
      </section>
      </div>
